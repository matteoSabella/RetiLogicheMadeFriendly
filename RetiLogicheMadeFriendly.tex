...
E si indicano ivalori delle uscite corrispondenti allo srato di partenza e all'ingresso sulla trnasizione.
\end{itemize}


\section{Analisi di circuiti sequenziali}

E' molto utile partire dal ciruicto ed estrarre il diagramma degli stati.
